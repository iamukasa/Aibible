...
public class MainActivity extends ActionBarActivity {
    ...
    SharedPreferences  mAIBibleSettings;
...
//         recyclerView.setAdapter(adapter);
    ...
    private void setToolBar() {
        ...
        mViewPager.setColor(getResources().getColor(R.color.act_back),4);
            ...
            toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    if(id==R.id.action_about){
                        Intent upIntent = new Intent(getApplicationContext(),About.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_about){
            Intent upIntent = new Intent(this,About.class);
             startActivity(upIntent);
    ...
    private class ResponseReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equalsIgnoreCase(Constants.BROADCAST_ACTION_BRAIN_ANSWER)) {
                ...
                final String det=mAIBibleSettings.getString(Constants.PREF_SOUND,null);
                if(det.equals("true")){
    ...
    protected Dialog onCreateDialog(final int id) {
        switch (id) {
            case SET_SOUNDS:
                ...
                if(mAIBibleSettings.contains(Constants.PREF_SOUND)
                        &
                     mAIBibleSettings.getString(Constants.PREF_SOUND,null).equals("true")){
                    g.setChecked(true);
                }
                ...
                g.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        if (isChecked) {
                            final SharedPreferences.Editor editor22 = mAIBibleSettings.edit();
